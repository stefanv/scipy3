...
DATA_DIR = os.path.join(os.path.dirname(__file__), "data", "boost")
...
def test_all():
    ...
    TESTS = [
        ...
        Data(beta, 'beta_exp_data_ipp/beta_exp_data.txt', (0,1), 2),
        Data(beta, 'beta_small_data_ipp/beta_small_data.txt', (0,1), 2),

        Data(cbrt, 'cbrt_data_ipp/cbrt_data.txt', 1, 0),

        Data(digamma, 'digamma_data_ipp/digamma_data.txt', 0, 1),
        Data(digamma, 'digamma_data_ipp/digamma_data.txt', 0j, 1),
        Data(digamma, 'digamma_neg_data_ipp/digamma_neg_data.txt', 0, 1, rtol=1e-13),
        Data(digamma, 'digamma_neg_data_ipp/digamma_neg_data.txt', 0j, 1, rtol=1e-13),
        Data(digamma, 'digamma_root_data_ipp/digamma_root_data.txt', 0, 1, rtol=1e-12),
        Data(digamma, 'digamma_root_data_ipp/digamma_root_data.txt', 0j, 1, rtol=1e-12),
        Data(digamma, 'digamma_small_data_ipp/digamma_small_data.txt', 0, 1),
        Data(digamma, 'digamma_small_data_ipp/digamma_small_data.txt', 0j, 1),

        Data(ellipk_, 'ellint_k_data_ipp/ellint_k_data.txt', 0, 1),
        Data(ellipe_, 'ellint_e_data_ipp/ellint_e_data.txt', 0, 1),
        Data(ellipeinc_, 'ellint_e2_data_ipp/ellint_e2_data.txt', (0,1), 2),

        Data(erf, 'erf_data_ipp/erf_data.txt', 0, 1),
        Data(erf, 'erf_data_ipp/erf_data.txt', 0j, 1, rtol=1e-14),
        Data(erfc, 'erf_data_ipp/erf_data.txt', 0, 2),
        Data(erf, 'erf_large_data_ipp/erf_large_data.txt', 0, 1),
        Data(erf, 'erf_large_data_ipp/erf_large_data.txt', 0j, 1),
        Data(erfc, 'erf_large_data_ipp/erf_large_data.txt', 0, 2),
        Data(erf, 'erf_small_data_ipp/erf_small_data.txt', 0, 1),
        Data(erf, 'erf_small_data_ipp/erf_small_data.txt', 0j, 1),
        Data(erfc, 'erf_small_data_ipp/erf_small_data.txt', 0, 2),

        Data(erfinv, 'erf_inv_data_ipp/erf_inv_data.txt', 0, 1),
        Data(erfcinv, 'erfc_inv_data_ipp/erfc_inv_data.txt', 0, 1),
        #Data(erfcinv, 'erfc_inv_big_data_ipp/erfc_inv_big_data.txt', 0, 1),

        Data(exp1, 'expint_1_data_ipp/expint_1_data.txt', 1, 2),
        Data(exp1, 'expint_1_data_ipp/expint_1_data.txt', 1j, 2, rtol=2e-9),
        Data(expi, 'expinti_data_ipp/expinti_data.txt', 0, 1, rtol=1e-13,
             param_filter=(lambda x: x>0)),
        Data(expi, 'expinti_data_double_ipp/expinti_data_double.txt', 0, 1,
             param_filter=(lambda x: x>0)),
        ...
        Data(iv, 'bessel_i_data_ipp/bessel_i_data.txt', (0,1), 2, rtol=1e-12),
        Data(iv, 'bessel_i_data_ipp/bessel_i_data.txt', (0,1j), 2, rtol=2e-10, atol=1e-306),
        Data(iv, 'bessel_i_int_data_ipp/bessel_i_int_data.txt', (0,1), 2, rtol=1e-9),
        Data(iv, 'bessel_i_int_data_ipp/bessel_i_int_data.txt', (0,1j), 2, rtol=2e-10),

        Data(jn, 'bessel_j_int_data_ipp/bessel_j_int_data.txt', (0,1), 2, rtol=1e-12),
        Data(jn, 'bessel_j_int_data_ipp/bessel_j_int_data.txt', (0,1j), 2, rtol=1e-12),
        Data(jn, 'bessel_j_large_data_ipp/bessel_j_large_data.txt', (0,1), 2, rtol=6e-11),
        Data(jn, 'bessel_j_large_data_ipp/bessel_j_large_data.txt', (0,1j), 2, rtol=6e-11),
        
        Data(jv, 'bessel_j_int_data_ipp/bessel_j_int_data.txt', (0,1), 2, rtol=1e-12),
        Data(jv, 'bessel_j_int_data_ipp/bessel_j_int_data.txt', (0,1j), 2, rtol=1e-12),
        Data(jv, 'bessel_j_data_ipp/bessel_j_data.txt', (0,1), 2, rtol=1e-12),
        Data(jv, 'bessel_j_data_ipp/bessel_j_data.txt', (0,1j), 2, rtol=1e-12),

        Data(kn, 'bessel_k_int_data_ipp/bessel_k_int_data.txt', (0,1), 2, rtol=1e-12),
        Data(kn, 'bessel_k_int_data_ipp/bessel_k_int_data.txt', (0,1), 2, rtol=1e-12),

        Data(kv, 'bessel_k_int_data_ipp/bessel_k_int_data.txt', (0,1), 2, rtol=1e-12),
        Data(kv, 'bessel_k_int_data_ipp/bessel_k_int_data.txt', (0,1j), 2, rtol=1e-12),
        Data(kv, 'bessel_k_data_ipp/bessel_k_data.txt', (0,1), 2, rtol=1e-12),
        Data(kv, 'bessel_k_data_ipp/bessel_k_data.txt', (0,1j), 2, rtol=1e-12),

        Data(yn, 'bessel_y01_data_ipp/bessel_y01_data.txt', (0,1), 2, rtol=1e-12),
        Data(yn, 'bessel_yn_data_ipp/bessel_yn_data.txt', (0,1), 2, rtol=1e-12),

        Data(yv, 'bessel_yn_data_ipp/bessel_yn_data.txt', (0,1), 2, rtol=1e-12),
        Data(yv, 'bessel_yn_data_ipp/bessel_yn_data.txt', (0,1j), 2, rtol=1e-12),
        Data(yv, 'bessel_yv_data_ipp/bessel_yv_data.txt', (0,1), 2, rtol=1e-12),
        Data(yv, 'bessel_yv_data_ipp/bessel_yv_data.txt', (0,1j), 2, rtol=1e-10),

        Data(zeta_, 'zeta_data_ipp/zeta_data.txt', 0, 1, param_filter=(lambda s: s > 1)),
        Data(zeta_, 'zeta_neg_data_ipp/zeta_neg_data.txt', 0, 1, param_filter=(lambda s: s > 1)),
        Data(zeta_, 'zeta_1_up_data_ipp/zeta_1_up_data.txt', 0, 1, param_filter=(lambda s: s > 1)),
        Data(zeta_, 'zeta_1_below_data_ipp/zeta_1_below_data.txt', 0, 1, param_filter=(lambda s: s > 1)),
